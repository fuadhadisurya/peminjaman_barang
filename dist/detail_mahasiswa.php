                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <table>
                                ...
                                <img src="image/mahasiswa/<?php echo $row['gambar'] ?>" alt="mahasiswa" width="960px">
                                <?php } ?>
                            </div>
                            <div class="card-footer">
                                <a href="data_mahasiswa.php" class="btn btn-primary"><i class="fas fa-angle-double-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </main>
